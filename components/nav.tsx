...
import { ArrowLeftCircleIcon, Bars3Icon, CpuChipIcon, EnvelopeIcon, ArchiveBoxIcon, InformationCircleIcon, PuzzlePieceIcon, UserCircleIcon, EllipsisHorizontalCircleIcon } from '@heroicons/react/24/solid';
                ...
                <div className='flex items-center w-full h-full space-y-6 justify-between flex-col'>
                    <div className='flex space-y-6 flex-col'>
                        <div onClick={() => router.push("/")} className="flex space-x-6 items-center cursor-pointer select-none">
                            <SparklesIcon className="w-[30px] h-[30px] text-blue-300" />
                            <span className="tracking-wide text-[21px] w-[155px] text-slate-200 font-bold">king chess</span>
                            <div className="rounded-md bg-slate-700 text-slate-600 text-sm flex items-center space-x-[6px] justify-center p-2 py-1">
                        ...
                        <div  onClick={() => router.push("/")} className='flex space-x-6 items-center group cursor-pointer'>
                            <ArchiveBoxIcon className="w-[24px] h-[24px] ml-[3px] stroke-[2] text-slate-600 group-hover:text-blue-300 trans" />
                        ...
                        {/* <div  onClick={() => router.push("/dms")} className='flex space-x-6 items-center group cursor-pointer'>
                            <ChatBubbleOvalLeftIcon className="w-[24px] h-[24px] ml-[3px] stroke-[2] text-slate-600 group-hover:text-blue-300 trans" />
                        ...
                        <div onClick={() => router.push("/my-games")} className='flex space-x-6 items-center group cursor-pointer'>
                            <InboxStackIcon className="w-[24px] h-[24px] ml-[3px] stroke-[2] text-slate-600 group-hover:text-blue-300 trans" />
                        ...
                        <div  onClick={() => router.push("/settings")} className='flex space-x-6 items-center group cursor-pointer'>
                            <CogIcon className="w-[24px] h-[24px] ml-[3px] stroke-[2] text-slate-600 group-hover:text-blue-300 trans" />
                    ...
                    <div className='flex items-center space-x-6 w-full'>
                        <div onClick={signOut} className="flex cursor-pointer btnAnimation items-center w-fit p-[7px] bg-blue-400/10 rounded-md">
                            <ArrowLeftOnRectangleIcon className="w-[20px] text-blue-300 h-[20px] stroke-[2.5]" />
                        </div>
                        <div className='w-full h-fit'>
                            <div className='flex items-center hover:brightness-[1.1] cursor-pointer trans space-x-4 rounded-xl bg-slate-700 px-2 py-2'>
                                <Image alt="pic" width={40} height={40} className='rounded-xl border-slate-500' src={user?.photoURL} />
